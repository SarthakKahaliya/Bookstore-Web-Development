...
public class ApiResource {
    ...
    public List<Book> suggestedBooks(@PathParam("category-id") long categoryId,
        ...
        try {
            ...
            throw new ApiException(String.format("products lookup via category Id %d failed", categoryId), e);
        }
    }
    ...
    public List<Book> booksByCategoryName(@PathParam("category-name") String categoryName,
        ...
        try {
            ...
            return bookDao.findByCategoryName(category.getName());
        } catch (Exception e) {
    ...
    public List<Book> suggestedBooksbyName(@PathParam("category-name") String categoryName,
        ...
        try {
            ...
            throw new ApiException(String.format("products lookup via category Name %s failed", categoryName), e);
        }
    }
